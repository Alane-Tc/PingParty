window.addEventListener("load", function () {
    ...
    randomImage[0] = "../Img/Monedas/Cara-sol.png";
    randomImage[1] = "../Img/Monedas/cruz-sol.png";
    randomImage[2] = "../Img/Monedas/cruz-sol.png";
    randomImage[3] = "../Img/Monedas/Cara-sol.png";
    randomImage[4] = "../Img/Monedas/cruz-sol.png";
    randomImage[5] = "../Img/Monedas/Cara-sol.png";
    ...
    let lanzarNuevo = () => { window.location = "moneda2.html" }
