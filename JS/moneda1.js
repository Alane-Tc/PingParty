window.addEventListener("load", function () {
    ...
    randomImage[0] = "../Img/Monedas/Cara-peso.png";
    randomImage[1] = "../Img/Monedas/cruz-pesos.png";
    randomImage[2] = "../Img/Monedas/cruz-pesos.png";
    randomImage[3] = "../Img/Monedas/Cara-peso.png";
    randomImage[4] = "../Img/Monedas/cruz-pesos.png";
    randomImage[5] = "../Img/Monedas/Cara-peso.png";
    ...
    let lanzarNuevo = () => { window.location = "moneda1.html" }
