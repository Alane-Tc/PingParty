window.addEventListener("load", function () {
    ...
    randomImage[0] = "../Img/Monedas/cara-peso2.png";
    randomImage[1] = "../Img/Monedas/cruz-pesos2.png";
    randomImage[2] = "../Img/Monedas/cruz-pesos2.png";
    randomImage[3] = "../Img/Monedas/cara-peso2.png";
    randomImage[4] = "../Img/Monedas/cruz-pesos2.png";
    randomImage[5] = "../Img/Monedas/cara-peso2.png";
    ...
    let lanzarNuevo = () => { window.location = "monedas4.html" }
